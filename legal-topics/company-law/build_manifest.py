...
add("DR-MARKET-ENTITY-IMPLEMENT-2022",
    ...
    relation_strength="direct",
    legal_status="effective",
    status_basis="user_confirmed_metadata",
    status_basis_url=None,
    ...
    notes="根据已确认元数据登记；正文仍仅为本地候选文本，verification_status 保持 CANDIDATE。"
)

# 5) 公司登记配套规范性文件（本轮仅登记已确认元数据；候选库未找到全文）
add("DR-COMPANY-REGISTRATION-IMPLEMENT-2025",
    title="公司登记管理实施办法",
    document_type="部门规章",
    relation_type="department_rule",
    relation_strength="core",
    ...
    verification_status="CANDIDATE",
    issuing_authority="国家市场监督管理总局",
    document_number="国家市场监督管理总局令第95号",
    publication_date="2024-12-20",
    effective_date="2025-02-10",
    source_url=None,
    local_path=None,
    notes="按已确认元数据登记；两个本地候选库均未找到正式标题、文号或唯一 ID 对应全文。"
)
add("NF-ENTITY-REGISTRATION-DOC-2026",
    title="经营主体登记文书规范（2026年版）",
    document_type="规范性文件",
    relation_type="normative_document",
    relation_strength="direct",
    legal_status="effective",
    status_basis="user_confirmed_metadata",
    status_basis_url=None,
    ...
    verification_status="CANDIDATE",
    issuing_authority="国家市场监督管理总局",
    document_number="国市监注发〔2026〕5号（文件组）",
    publication_date="2026-01-12",
    effective_date="2026-05-01",
    source_url=None,
    local_path=None,
    notes="直接落实公司法关于股东出资期限、股东失权、弥补亏损减资等登记要求；本地候选库未找到全文。"
)
add("NF-ENTITY-REGISTRATION-MATERIALS-2026",
    title="经营主体登记提交材料规范（2026年版）",
    document_type="规范性文件",
    relation_type="normative_document",
    relation_strength="direct",
    legal_status="effective",
...
add("NF-ENTITY-REGISTRATION-NOTICE-2026",
    ...
    verification_status="CANDIDATE",
    issuing_authority="国家市场监督管理总局",
    document_number="国市监注发〔2026〕5号",
    publication_date="2026-01-12",
    effective_date="2026-05-01",
    source_url=None,
    local_path=None,
    notes="上位通知；本地候选库未找到全文。"
)
add("NF-ENTITY-REGISTRATION-DOC-2022-REPLACED",
    title="市场主体登记文书规范（2022版）",
    document_type="规范性文件",
    relation_type="historical_version",
    relation_strength="related",
    legal_status="replaced",
    ...
    source_url=None,
    local_path=None,
    replaced_by="NF-ENTITY-REGISTRATION-DOC-2026",
    replacement_effective_date="2026-05-01",
    notes="由2026年版替代；不进入当前默认检索范围。"
)
add("NF-ENTITY-REGISTRATION-MATERIALS-2022-REPLACED",
    title="市场主体登记提交材料规范（2022版）",
    document_type="规范性文件",
    relation_type="historical_version",
    relation_strength="related",
    legal_status="replaced",
    ...
    source_url=None,
    local_path=None,
    replaced_by="NF-ENTITY-REGISTRATION-MATERIALS-2026",
    replacement_effective_date="2026-05-01",
    notes="由2026年版替代；不进入当前默认检索范围。"
)
...
SEED_CASES = [
    {
        ...
        "reference_status_effective_date": None,
        "verification_status": "OFFICIAL_META",
        ...
        "status_basis": "最高人民法院指导性案例215号官方发布页面 + 2026年生态环境领域指导性案例集中清理结果",
        "notes": "2026年集中清理生态环境领域45件指导性案例，明确不再参照的是123、136、139、204号；215号未列入不再参照清单。正文未逐字保存和核验。",
        "analysis_note": {
    ...
    },
    {
        ...
        "candidate_sources": [],
        "official_holding": None,
        "status_basis": "最高人民法院公开发布的入库参考案例页面",
        "notes": "入库编号已确认；当前仓库没有逐字核验的官方裁判要旨，因此不新增 official_holding。",
        "analysis_note": {
            "content_type": "ai_summary",
    ...
    },
    {
        ...
        "case_authority": "guiding_case",
        "case_type": "guiding_case",
        "reference_status": "no_longer_reference",
        "reference_status_effective_date": "2021-01-01",
        "verification_status": "OFFICIAL_META",
        ...
        "candidate_sources": [],
        "official_holding": None,
        "status_basis": "最高人民法院《关于部分指导性案例不再参照的通知》法〔2020〕343号",
        "notes": "自2021年1月1日起不再参照；原案例裁判以及此前参照该案例作出的裁判仍然有效。",
        "analysis_note": {
            "content_type": "ai_summary",
...
def build_manifest():
    ...
    manifest = {
        ...
        "update_state": {
            ...
            "candidate_commits": {
                "just-laws": "56770b043bf19686fec43403bd24e8e290275794",
                "lawtext-laws": "aefdfca37fb06e90a29af6311a1ed9804c9670bd",
                "china-data-laws": "1ca7a3518d115c8dd3b752849ebdfa09878fa1b0",
            },
        },
    }
        ...
        "records": [
            {
                "guiding_case_number": "215",
                "reference_status": "active",
                "status_basis": "最高人民法院指导性案例215号官方发布页面 + 2026年生态环境领域指导性案例集中清理结果；215号未列入不再参照清单。",
                "checked_at": "2026-09-11",
            },
            {
                "guiding_case_number": "9",
