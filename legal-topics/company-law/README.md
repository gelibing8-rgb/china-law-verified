...
| --- | --- | --- | --- | --- | --- |
| 国家市场监督管理总局令第52号 | 中华人民共和国市场主体登记管理条例实施细则 | 2022-03-01 | **pending_verification** | **CANDIDATE** | `china-data-laws/部门规章/市场监督管理总局/市场主体登记管理条例实施细则(2022-03-01).md` |

该条目是本地候选库命中的直接配套规则；本轮未访问政府网站，不能据此确认当前仍有效，故不列入“现行有效”清单。

本轮本地盘点未发现《公司登记管理实施办法》、经营主体登记文书规范或经营主体登记提交材料规范的可靠唯一全文匹配；未做模糊关联。

### 重要规范性文件

**暂无已确认现行规范性文件。** 相关登记文书/提交材料规范在本轮候选库中未找到可靠唯一匹配。
...
1. 部门规章 / 规范性文件：目前仅有 1 项 `pending_verification` 候选，尚无已核验现行部门规章；登记文书/提交材料规范未找到可靠匹配
